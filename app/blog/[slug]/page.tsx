              ...
              <div key={relatedPost.slug} className="rounded-lg overflow-hidden shadow-md">
                <Link href={`/blog/${relatedPost.slug}`}>
                  <div className="aspect-[16/9] relative">
                    <Image
                      src={relatedPost.coverImage || `https://picsum.photos/seed/${relatedPost.slug}/800/450`}
          ...
          <div key={index} className="my-8">
            ...
            {section.image && (
              <figure className="my-6">
                <Image
                  src={section.image.src || `https://picsum.photos/seed/${post.slug}-${index}/800/400`}
    ...
    <>
      ...
      <main>
        <div className="relative h-[30vh] md:h-[40vh] min-h-[320px] md:min-h-[400px] bg-black">
          <Image
            src={post.coverImage || `https://picsum.photos/seed/${post.slug}/1200/600`}
